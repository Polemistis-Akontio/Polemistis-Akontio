...
-------------------------
- MachineLearningProject was a project I built and showcased for a machine learning class, achieving a 64% accuracy rating for the 2024-2025 NFL Season, on par with FiveThirtyEight and Vegas predictions.
- ImageSteganographyProject was a project where my team and I used the least significant bit in images to encrypt, encode, and then decrypt and decode hidden messages. 
